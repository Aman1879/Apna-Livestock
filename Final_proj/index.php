...
<div id="app-wrap" class="w-full h-full min-h-screen">
  ...
  <nav id="dashboardMenu" class="dashboard-menu menu-panel fixed left-0 top-0 z-40 w-60 h-full py-10 px-3 flex flex-col gap-3 glass transition-all fade-in" style="transition:left .38s cubic-bezier(.31,1.8,.47,1)">
   ...
   <a href="logout.php" class="w-full py-2 px-4 rounded-md text-left hover:bg-red-100 text-red-600 flex items-center gap-2 font-bold text-base transition-all">
          ...
          <div class="w-full flex flex-col px-3 pt-7 pb-3 max-w-7xl mx-auto relative">
            ...
            <div class="flex flex-col md:flex-row md:justify-between items-center gap-y-2 w-full">
              ...
              <div class="flex gap-4 items-center mt-2 md:mt-0">
                ...
                <img id="profileImageDash" src="wh.jpg" alt="profile" class="profile-img border border-blue-100"/>
              </div>
            </div>
            ...
            <div class="mb-6 grid md:grid-cols-2 gap-7">
              ...
              <div class="info-card p-7">
                <div class="text-purple-800 text-xl font-bold flex items-center gap-2 mb-3">
                  <i class="fa fa-users text-purple-500"></i> Meet the Owners
                </div>
                <div class="grid grid-cols-2 gap-5">
                  <!-- Owner 1 -->
                  <div class="flex items-center gap-3">
                    <img src="wh.jpg" class="owner-avatar" alt="Owner Aman" onerror="this.src='https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.2/svgs/solid/user.svg'">
                    <div>
                  ...
                  <!-- Owner 2 -->
                  <div class="flex items-center gap-3">
                    <img src="rudra.jpg" class="owner-avatar" alt="Owner 2">
                    <div>
                      <div class="font-bold text-blue-700">Rudrajeet</div>
                      <div class="text-xs text-blue-400">Co-Owner</div>
                      <div class="text-xs text-gray-500">rudrajeet@apnalivestock.com</div>
                    </div>
                  </div>
                  <!-- Owner 3 -->
                  <div class="flex items-center gap-3">
                    <img src="unnat.jpg" class="owner-avatar" alt="Owner 3">
                    <div>
                      <div class="font-bold text-blue-700">Unnat</div>
                      <div class="text-xs text-blue-400">Tech Head</div>
                      <div class="text-xs text-gray-500">unnat@apnalivestock.com</div>
                    </div>
                  </div>
                  <!-- Owner 4 -->
                  <div class="flex items-center gap-3">
                    <img src="surya.jpg" class="owner-avatar" alt="Owner 4">
                    <div>
                      <div class="font-bold text-blue-700">Suryakant</div>
                      <div class="text-xs text-blue-400">Support Manager</div>
                      <div class="text-xs text-gray-500">surya@apnalivestock.com</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="glass glass-card max-w-2xl p-7 mx-3">
            <form id="profileForm" class="space-y-5">
              <div class="flex gap-7 items-center mb-4">
                <img id="profileImage" src="wh.jpg" alt="Profile" class="profile-img border border-blue-100"/>
                <input type="text" id="profileImageUrl" class="border px-2 py-1 rounded" placeholder="Enter image URL or filename" value="wh.jpg">
                <button type="button" class="ml-2 px-3 py-1 text-xs bg-blue-100 rounded hover:bg-blue-200 font-bold" onclick="updateProfilePic()">Update</button>
              </div>
              <div class="grid gap-4 md:grid-cols-2">
                <div>
                  <label class="font-medium text-blue-800">Full Name</label>
                  <input type="text" id="profileName" class="border px-2 py-1 rounded w-full mt-1" value="Aman" >
                </div>
                <div>
                  <label class="font-medium text-blue-800">Role/Designation</label>
                  <input type="text" id="profileRole" class="border px-2 py-1 rounded w-full mt-1" value="Owner & Operator" >
                </div>
                <div>
                  <label class="font-medium text-blue-800">Email</label>
                  <input type="email" id="profileEmail" class="border px-2 py-1 rounded w-full mt-1" value="amanara13579@gmail.com">
                </div>
                <div>
                  <label class="font-medium text-blue-800">Phone</label>
                  <input type="tel" id="profilePhone" class="border px-2 py-1 rounded w-full mt-1" value="+91-6299211631" >
                </div>
              </div>
  ...
  <div id="animalModal" class="fixed-modal-centered glass glass-card shadow-2xl p-7 hidden">
    ...
    <form id="animalForm" autocomplete="off" class="space-y-3">
      ...
      <div>
        ...
        <input type="text" class="border rounded w-full py-2" id="animalImage" placeholder="wh.jpg or https://...">
      </div>
